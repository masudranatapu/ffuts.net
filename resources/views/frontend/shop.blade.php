...
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
    <div class="col mb-3">
        <div class="prodouct_wrap">
            ...
            <div class="product_img">
                <a href="{{ route('details') }}"><img src="{{ asset('frontend/images/1.jpg') }}" class="w-100"
                        alt="image"></a>
            </div>
    ...
    <div class="col mb-3">
        <div class="prodouct_wrap">
            ...
            <div class="product_img">
                <a href="{{ route('details') }}"><img src="{{ asset('frontend/images/2.jpg') }}" class="w-100"
                        alt="image"></a>
            </div>
            <div class="product_content">
                <h5>$55.55</h5>
    ...
    <div class="col mb-3">
        <div class="prodouct_wrap">
            ...
            <div class="product_img">
                <a href="{{ route('details') }}"><img src="{{ asset('frontend/images/3.jpg') }}" class="w-100"
                        alt="image"></a>
            </div>
            <div class="product_content">
                <h5>$55.55</h5>
    ...
    <div class="col mb-3">
        <div class="prodouct_wrap">
            ...
            <div class="product_img">
                <a href="{{ route('details') }}"><img src="{{ asset('frontend/images/4.jpg') }}" class="w-100"
                        alt="image"></a>
            </div>
            <div class="product_content">
                <h5>$55.55</h5>
