                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="category_heading text-center">
                                        <h5><a
                                                href="{{ route('search',['country'=>$country,'ad_type' => $ad_type->slug]) }}">{{
                                                __($ad_type->slug) }}</a></h5>
                                    </div>
                                    <div class="row g-1">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="mt-2">
                                                <ul class="list-group category_list">
                                                    <li><a
                                                            href="{{ route('search',['country'=>$country,'ad_type' => $ad_type->slug, 'categories' => $item->slug]) }}">{{
                                                            __($item->slug) }}</a></li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="heading3 text-center">
                        ...
                        <form action="{{ route('frontend.setCountry') }}" method="post">
                            ...
                            <select name="country" id="country"
                                ...
                                <option value="{{ $iso }}" {{ $country==$iso ? 'selected' : '' }}>{{ $row->name }}
                                </option>
                                @endforeach
                                @endif
                            </select>
